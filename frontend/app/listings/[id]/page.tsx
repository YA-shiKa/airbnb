          ...
          {listing.latitude != null && listing.longitude != null && (
            <div className="py-6 border-b border-hairline">
              ...
              <div className="rounded-xl2 overflow-hidden border border-hairline">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={`https://staticmap.openstreetmap.de/staticmap.php?center=${listing.latitude},${listing.longitude}&zoom=12&size=650x300&markers=${listing.latitude},${listing.longitude},red-pushpin`}
                  alt={`Map showing the location of ${listing.title} in ${listing.city}, ${listing.country}`}
