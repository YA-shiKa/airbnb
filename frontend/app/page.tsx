...
export default function ExplorePage() {
  ...
  // Whenever the shared search (driven by either the navbar pill or the
  // inline search bar below) changes, jump back to page 1 of results.
  useEffect(() => {
    setPage(1);
  }, [searchValues]);
  ...
  const loadListings = useCallback(() => {
    ...
    api
      .searchListings({
        location: searchValues.location || undefined,
        check_in: searchValues.checkIn || undefined,
        check_out: searchValues.checkOut || undefined,
        guests: searchValues.guests > 1 ? searchValues.guests : undefined,
  ...
  }, [searchValues, category, filters, page, user?.id]);
  ...
  return (
    <div className="max-w-[1760px] mx-auto px-4 md:px-10">
      <div id="search-bar" className="py-6 sticky top-20 z-40 bg-white">
        <SearchBar initial={searchValues} onSearch={setSearchValues} />
      </div>
